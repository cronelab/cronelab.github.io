    ...
    <>
      ...
      <ListGroup>
        <ListGroupItem>
          ...
          Templer, Joshua M. Rosenow, Matthew C. Tate, Richard Betzel & Marc W.
        ...
        <ListGroupItem>
          ...
          Tippett, D. C., Maragakis, N., Tenore, F. V., Fifer, M. S., Hermansky,
          H., Ramsey, N. F., & Crone, N. E. (2024). Online speech synthesis
          using a chronically implanted brain–computer interface in an
          individual with ALS. Scientific Reports, 14(1), 9617.
        </ListGroupItem>
        <ListGroupItem>
          Wyse-Sookoo, K., Luo, S., Candrea, D., Schippers, A., Tippett, D. C.,
          Wester, B., Fifer, M., Vansteensel, M. J., Ramsey, N. F., & Crone, N.
          E. (2024). Stability of ECoG high gamma signals during speech and
          implications for a speech BCI system in an individual with ALS: A
        ...
        <ListGroupItem>
          ...
          Raemaekers, M., Schippers, A., Verberne, M., Aarnoutse, E. J., &
          Ramsey, N. F. (2024). Longevity of a Brain–Computer Interface for
        ...
        <ListGroupItem>
          ...
          Tippett, D. C., Maragakis, N. J., Clawson, L. L., Vansteensel, M. J.,
          Wester, B. A., Tenore, F. V., Hermansky, H., Fifer, M. S., Ramsey, N.
          F., & Crone, N. E. (2023). Stable Decoding from a Speech BCI Enables
        ...
        <ListGroupItem>
          ...
          Neurotherapeutics 2022; 1-11
        </ListGroupItem>
        <ListGroupItem>
          Meeker TJ, Emerson N, Chien JH, Saffer MI, Bienvenu OJ, Korzeniewska
          A, Greenspan JD, Lenz FA. During Vigilance to Painful Stimuli: Slower
          Response Rate Related to High Trait Anxiety, whereas a Faster Response
        ...
        <ListGroupItem>
          ...
          Wyckoff S, Barot N, Gonzalez-Martinez J, Sarma SV. Source-sink
        ...
        <ListGroupItem>
          ...
          with Conditioned Fear as Sensors for Fear and Anxiety. Sensors.
          2020;20(23):6751.
        </ListGroupItem>
        <ListGroupItem>
          ...
          task with a painful target. Journal of Neurophysiology.
          2020;123(2):462-472.
        </ListGroupItem>
        <ListGroupItem>
          Alhourani A, Korzeniewska A, Wozny TA, Lipski WJ, Kondylis ED, Ghuman
          AS, Crone NE, Crammond DJ, Turner RS, Richardson RM. Subthalamic
        ...
        <ListGroupItem>
          ...
          revealed by single-pListGroupse electrical brain stimListGroupation."
          Sleep (2019).
        </ListGroupItem>
        <ListGroupItem>
        ...
        <ListGroupItem>
          ...
          (Ventral Caudal - Vc) as a locus for stimListGroupation by signals
          from sensors in active prostheses. Sensors 17(6) 1197.
        </ListGroupItem>
        <ListGroupItem>
          Nishida M., Korzeniewska A., Crone N.E. Toyoda G., Nakai Y., Ofen N.,
          Brown E.C., Asano E. 2017. Brain network dynamics in the human
          articListGroupatory loop. CListGroupItemnical Neurophysiology
          128:1473-1487.
        </ListGroupItem>
        <ListGroupItem>
          Chien J.H., Colloca L., Korzeniewska A., Cheng J.J., Campbell C.M.,
          HilListGroupItems A.E., Lenz F.A. 2017. Oscillatory EEG activity
          induced by conditioning stimListGroupi during fear conditioning
          reflects SaListGroupItemence and Valence of these stimListGroupi more
          than Expectancy. Neuroscience 346:81-93.
        </ListGroupItem>
        <ListGroupItem>
          Collard M.J., Fifer M.S., Benz H.L., McMListGrouplen D., Wang Y.,
          Milsap G.W., Korzeniewska A., Crone N.E. 2016. Cortical subnetwork
          dynamics during human language tasks. Neuroimage 135:261-72.
        </ListGroupItem>
        <ListGroupItem>
          Wang Y., Fifer M.S., FListGroupItemnker A., Korzeniewska A., Cervenka
          M.C., Anderson W.S., Boatman-Reich D.F., Crone N.E. 2016.
          Spatial-temporal functional mapping of language at the bedside with
        ...
        <ListGroupItem>
          Markman T, ListGroupItemu CC, Chien JH, Crone NE, Zhang J, Lenz FA.
          ERC analysis of scalp EEG reveals widespread directed functional
          interactions related to a painfListGroup cutaneous laser
          stimListGroupus. Journal of neurophysiology 2013.
        </ListGroupItem>
        <ListGroupItem>
        ...
        <ListGroupItem>
          ...
          Toward electrocorticographic control of a dexterous upper
          ListGroupItemmb prosthesis: building brain-machine interfaces. IEEE
          PListGroupse 2012; 3(1):38-42.
        </ListGroupItem>
        <ListGroupItem>
        ...
        <ListGroupItem>
          ...
          frequencies during word production: Event related causaListGroupItemty
          (ERC) analysis of human electrocorticography (ECoG). Neuroimage 2011;
          56(4), 2218-2237.
        </ListGroupItem>
        <ListGroupItem>
        ...
        <ListGroupItem>
          ...
          Electrocorticographic ampListGroupItemtude predicts finger positions
          during slow grasping motions of the hand. Journal of Neural
          Engineering 2010;7(4):046002
        </ListGroupItem>
        <ListGroupItem>
        ...
        <ListGroupItem>
          ...
          potentials and their potential impListGroupItemcations in
          electrocorticography. Journal of Neuroscience, 2008 Nov
          5;28(45):11526-36.
        </ListGroupItem>
        <ListGroupItem>
          Korzeniewska A, Crainiceanu CM, Kus R, Franaszczuk PJ, Crone NE.
          Dynamics of event-related causaListGroupItemty (ERC) in brain
          electrical activity. Human Brain Mapping, 2008 Oct;29(10):1170-92.
        </ListGroupItem>
        <ListGroupItem>
          Testa SM, Ward J, Crone NE, Brandt J. StimListGroupus type affects
          Wada memory performance. Epilepsy & Behavior. 2008 Oct; 13(3):458-62.
        </ListGroupItem>
        <ListGroupItem>
        ...
        <ListGroupItem>
          ...
          MigListGroupItemoretti DL. Short-term variations in response
          distribution to cortical stimListGroupation. Brain, 2008
          Jun;131(6):1528-39. Epub 2008 Mar 12.
        </ListGroupItem>
        <ListGroupItem>
        ...
        <ListGroupItem>
          Kleinman JT, Sepkuty JP, HilListGroupItems AE, Lenz FA, Heidler-Gary
          J, Gingis L, Crone NE. Spatial neglect during electrocortical
          stimListGroupation mapping in the right hemisphere. Epilepsia, 2007
          Dec;48(12):2365-8. Epub 2007 JListGroup 21.
        </ListGroupItem>
        <ListGroupItem>
          ...
          into standardized common space. CListGroupItemnical EEG and
          Neuroscience, 2007 JListGroup;38(3):132-6.
        </ListGroupItem>
        <ListGroupItem>
        ...
        <ListGroupItem>
          ...
          MigListGroupItemoretti D. Speech recognition impairments in patients
          with right temporal lobe epilepsy. Epilepsia, 2006 Aug;
          47(8):1397-401.
        </ListGroupItem>
        <ListGroupItem>
        ...
        <ListGroupItem>
          ...
          mListGrouptichannel biomedical data. Acta Neurobiologiae
          ExperimentaListGroupItems, 2005; 65(4):443-52.
        </ListGroupItem>
        <ListGroupItem>
        ...
        <ListGroupItem>
          ...
          of laser evoked potential recorded from primary somatosensory,
          parasylvian and medial frontal cortex are graded with stimListGroupus
          intensity. Pain. 2004 JListGroup;110(1-2):318-28.
        </ListGroupItem>
        <ListGroupItem>
          Ohara S, Crone NE, Weiss N, Vogel H, Treede RD, Lenz FA. Attention to
          pain is processed at mListGrouptiple cortical sites in man.
          Experimental Brain Research, 2004 Jun;156(4):513-7.
        </ListGroupItem>
        <ListGroupItem>
        ...
        <ListGroupItem>
          Ohara S, Crone NE, Weiss N, Lenz FA. Attention to a painfListGroup
          cutaneous laser stimListGroupus modListGroupates electrocorticographic
          event-related desynchronization in humans. CListGroupItemnical
          Neurophysiology, 2004;115(7):1641-1652.
        </ListGroupItem>
        <ListGroupItem>
          Ohara S, Crone NE, Weiss N, Treede, R-D, Lenz FA. Cutaneous
          painfListGroup laser stimListGroupi evoke responses recorded directly
          from primary somatosensory cortex in awake humans. Journal of
          Neurophysiology, 2004 Jun;91(6):2734-46.
        </ListGroupItem>
        <ListGroupItem>
        ...
        <ListGroupItem>
          ...
          with late-onset seizures. Epilepsy & Behavior 2000;1(4):281-286.
        </ListGroupItem>
        <ListGroupItem>
      ...
      <ListGroup>
        ...
        <ListGroupItem>
          ...
          CListGroupItemnical Neurophysiology, 2010 Sep;121(9):1376-92. Review.
        </ListGroupItem>
        <ListGroupItem>
        ...
        <ListGroupItem>
          ...
          in CListGroupItemnical Brain Mapping, D. Yoshor and E. Mizrahi,
          Editors. In Press, McGraw-Hill Medical: New York, NY.
        </ListGroupItem>
      </ListGroup>
      ...
      <ListGroup>
        <ListGroupItem>
          Newman G, Fifer M, Benz H, Crone N, Thakor N. Eigenvector
          centraListGroupItemty reveals the time course of task-specific
          electrode connectivity in human ECoG. Conf Proc IEEE EMBS Neural
        ...
        <ListGroupItem>
          ...
          Neuroprosthetic ListGroupItemmb control with electrocorticography:
          Approaches and challenges. Conf Proc IEEE Engineering in Medicine and
        ...
        <ListGroupItem>
          Milsap G, Fifer M, Crone NE, Thakor NV, ListGroupItemstening to the
          Music of the Brain: ListGroupItemve Analysis of ECoG Recordings Using
          Digital Audio Workstation, Conf Proc IEEE EMBS Neural Engineering
          Conference, 2013
        </ListGroupItem>
        <ListGroupItem>
          Katyal K, Johannes M, McGee T, Harris A, Armiger R, Firpi AH,
          McMListGrouplen D, Hotson G, Fifer M, Crone NE, Vogelstein RJ, Wester
          B., HARMONIE: A MListGrouptimodal Control Framework for Human
          Assistive Robotics, Conf Proc IEEE EMBS Neural Engineering Conference,
          2013
        </ListGroupItem>
        <ListGroupItem>
          Fifer M, Milsap G, Greenwald E, McMListGrouplen D, Anderson WS, Thakor
          N, Crone NE, Vinjamuri R, Design and Implementation of a Human ECoG
          SimListGroupator for Testing Brain-Machine Interfaces, Conf Proc IEEE
          EMBS Neural Engineering Conference, 2013
        </ListGroupItem>
        <ListGroupItem>
          Ritaccio, Anthony, Peter Brunner, Nathan E. Crone, AysegListGroup
          Gunduz, Lawrence J. Hirsch, Nancy Kanwisher, Brian ListGroupItemtt et
          al. "Proceedings of the Fourth International Workshop on Advances in
          Electrocorticography." Epilepsy & Behavior 29, no. 2 (2013): 259-268.
        </ListGroupItem>
        <ListGroupItem>
          Benz HL, Collard M, Tsimpouris C, Acharya S, Crone NE, Thakor NV,
          Bezerianos A, Directed CausaListGroupItemty of the Human
          Electrocorticogram During Dexterous Movement, Conf Proc IEEE Eng Med
          Biol Soc, 2012
        </ListGroupItem>
        <ListGroupItem>
      ...
      <ListGroup>
        <ListGroupItem>
          Katyal, Kapil D., et al. "Hybrid augmented reaListGroupItemty
          mListGrouptimodal operation neural integration environment." U.S.
          Patent AppListGroupItemcation No. 14/275,029.
        </ListGroupItem>
      </ListGroup>

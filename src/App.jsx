    ...
    <Router basename={process.env.PUBLIC_URL}>
      <Container fluid>
        ...
        <Routes>
          ...
          <Route
            exact
            path="/languageconnectivity"
            element={<LangaugeConnectivity />}
          />
          <Route
            exact
            path="/seizureconnectivity"
            element={<SeizureConnectivity />}
          />
          ...
          <Route
            exact
            path="/functionalmapping"
            element={<FunctionalMapping />}
          />
          ...
          <Route
            exact
            path="/speech-test-flyer"
            element={<SpeechTestFlyer />}
          />
        </Routes>
        <hr />
        <Footer />
